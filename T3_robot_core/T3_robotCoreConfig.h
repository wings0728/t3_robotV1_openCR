#ifndef  _T3_ROBOT_CORE_CONFIG_
#define _T3_ROBOT_CORE_CONFIG_
...
#define TURNING_RADIUS                   0.080           // meter (BURGER : 0.080, WAFFLE : 0.1435)  equal (Wheel_separation / 2)
...
#define TEST_DISTANCE                    1.85//10//0.300     // meter
